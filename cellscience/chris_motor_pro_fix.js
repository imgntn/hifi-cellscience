var numDynein = 2;
var numKinesin = 2;
var restartedserver = 0
var percentOnMainMT = 100;
var proteinEntityIDs = [
    "{03b36337-547f-406e-934a-932a4478dd63}", // red  1
"{712d9c69-232a-4564-a93e-05feb7e6c771}", // red  2
"{1bf5359d-1540-4361-af85-7896fba6a0d2}", // blue 1
"{7872d8b6-15d9-4ce2-be1f-8777b1f7fdc0}" // blue 2
];
...
Agent.isAvatar = true;
EntityViewer.setPosition(Vec3.sum({
    x: -495.1377539,
    y: 447.6999851,
    z: 67.71881918
}, sceneOffset));

EntityViewer.setMaxPacketsPerSecond(6000);
var yaw = 45;
...
Script.setInterval(headlessClient, 1000);


var baseLocation = "http://hifi-public.s3.amazonaws.com/cellscience/";
//http://dynamoidapps.com/HighFidelity/Cosm/MotorProteins/dynein.fbx
var dyneinURL = this.baseLocation + "MotorProteins/dynein.fbx";
var dyneinid = "{6d02736b-e18b-4b9c-a679-eb4eff97c1a9}";
...
//http://dynamoidapps.com/HighFidelity/Cosm/MotorProteins/kinesin.fbx
var kinesinid = "{b80d7e02-5633-430d-8c88-6ab849d98434}";
...
var initialized = false;
    ...
    function update(deltaTime) {
        ...
        for (var i = 0; i < motorProteins.length; i++) {
            ...
            if (restartedserver == 0) {
                restartedserver = 1;
                Entities.editEntity(motorProteins[i].protein, {
                type: "Model",
                position: newPos,
                rotation: newRot,
                animationSettings: '{"startAutomatically":true}'
            });
            }
            Entities.editEntity(motorProteins[i].protein, {
                type: "Model",
